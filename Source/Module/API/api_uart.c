...
static volatile U8 uart0_tx_complete = TRUE;

static void Uart0RecvCallbackFunc(U8 rx_data);
...
static volatile U8 uart3_tx_complete = TRUE;

static void Uart3RecvCallbackFunc(U8 rx_data);
