...
#define ZONE_1_GAIN (0.8F)      // ½É°¢ °úÁ¦ºù
#define ZONE_2_GAIN (0.3F)      // »ìÂ¦ °úÁ¦ºù
#define ZONE_3_GAIN (0.3F)      // »ìÂ¦ ºÎÁ·
#define ZONE_4_GAIN (0.8F)      // ½É°¢ ºÎÁ·
#define ZONE_5_GAIN (0.1F)      // °ÅÀÇ ¸ÂÀ½ (MID_ZONE)
...
//for test
extern bit F_IceFull;                        // ï¿½Ë¡ï¿½ï¿½Ë¡ï¿½ï¿½ï¿½ï¿½ï¿½u
