...
void output_fan(void)
{
    ...
    if( gu8IceStep >= STATE_14_CHECK_ICE_TRAY_HZ && gu8IceStep <= STATE_43_GAS_SWITCH_HOT_GAS )
    {
    ...
    if( gu8IceStep >= STATE_44_CALC_HOT_GAS_TIME && gu8IceStep <= STATE_45_ICE_TAKE_OFF )
    {
