...
void fnd_right_tray_clean(void)
{
    ...
    if( gu8_drain_tank_ster_count == DRAIN_TANK__STER_CYCLE )
    {
        ...
        else if( gu8_ice_ster_mode == STER_MODE_HOT_WAIT_STATE )
        {
            ...
            else if( gu8_hot_wait_step >= 2 && gu8_hot_wait_step <= 4 )
            {
                gu8_tray_clean_percent = 30;
            }
            else if( gu8_hot_wait_step == 5 )
            {
                if( gu16_hot_wait_timer <= 1800 )
                {
                    gu8_tray_clean_percent = 30;
                }
                else if( gu16_hot_wait_timer <= 3600 )
                {
        ...
        else if( gu8_ice_ster_mode == STER_MODE_DRAIN_WAIT_STATE )
        {
            if( gu8_drain_wait_step <= 2 )
            {
                gu8_tray_clean_percent = 50;
            }
            else if( gu8_drain_wait_step == 3 )
            {
                if( gu16_drain_wait_timer <= 2400 )
                {
                    gu8_tray_clean_percent = 60;
                }
                else if( gu16_drain_wait_timer <= 4800 )
                {
                    gu8_tray_clean_percent = 70;
                }
                else if( gu16_drain_wait_timer <= 7200 )
                {
    ...
    else
    {
        ...
        else if( gu8_ice_ster_mode == STER_MODE_HOT_WAIT_STATE )
        {
            ...
            {
                if( gu16_hot_wait_timer <= 1000 )
                {
                    gu8_tray_clean_percent = 50;
                }
                else if( gu16_hot_wait_timer <= 2000 )
                {
                    gu8_tray_clean_percent = 60;
                }
                else if( gu16_hot_wait_timer <= 3000 )
                {
                    gu8_tray_clean_percent = 70;
                }
                else if( gu16_hot_wait_timer <= 4000 )
                {
                    gu8_tray_clean_percent = 80;
                }
                else
